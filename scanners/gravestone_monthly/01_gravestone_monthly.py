...
print("MONTHLY GRAVESTONE DOJI SCANNER\n")
...
OUT_DIR = Path(r"H:\CANDLE-LAB-MONTHLY\analysis\equity\signals\gravestone_monthly")
OUT_DIR.mkdir(parents=True, exist_ok=True)

today = datetime.now().strftime("%Y-%m-%d")
OUT_FILE = OUT_DIR / f"monthly_gravestone_{today}.csv"
